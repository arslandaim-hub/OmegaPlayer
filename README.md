...
width="300">
 ...
 #### PREMIUM AUDIO EXPERIENCE
  ...
  Folder-Based Navigation: Organize and browse your music exactly how you want.
  Dynamic Album Art: Beautiful blurred backgrounds that adapt to your music.
  Smart Controls: Repeat modes, skip, and smooth seek bars.

 #### PRIVATE MEDIA VAULT
 
  PIN & Biometric Protection: Secure your sensitive videos with a 4-digit PIN or Fingerprint.
  Stealth Security: Videos moved to the locker are hidden from the system gallery and other apps.
  Security Question: Advanced recovery options to ensure you never lose access.
  Auto-Lock: The vault automatically locks when you minimize the app for maximum privacy.

 #### MODERN & RESPONSIVE UI
 
  Material 3 Design: A clean, beautiful interface that supports Light and Dark modes.
  Optimized Performance: Lightweight and battery-efficient architecture.
